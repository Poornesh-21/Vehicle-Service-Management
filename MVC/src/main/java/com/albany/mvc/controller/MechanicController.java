...
public class MechanicController {
    ...
    public ResponseEntity<?> createMechanic(
        ...
        try {
            ...
            // The password field is now optional - the API will generate one if missing
            ...
            // Return the mechanic object with the generated password if one was created
            Map<String, Object> response = new HashMap<>();
            response.put("mechanic", createdMechanic);

            // If a password was generated by the API, it will be in the response
